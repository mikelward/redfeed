...
- [ ] Onboard the weekly npm dependency batch — the
      `dependency-update.yml` plus `scripts/check-dependency-update.mjs`
      pattern gedmap, newshacker, readmo and homepage share.
